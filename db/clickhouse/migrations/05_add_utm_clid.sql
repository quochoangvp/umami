...
SELECT website_id, session_id, visit_id, event_id, hostname, browser, os, device, ip, user_agent, screen, language, country, subdivision1, subdivision2, city, url_path, url_query,
